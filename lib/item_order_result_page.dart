...
class _ItemOrderResultPageState extends State<ItemOrderResultPage> {
  ...
  String generateOrderNumber() {
    ...
    String orderNo =
        "${dateTime.year}${dateTime.month}${dateTime.day}-${dateTime.hour}${dateTime.minute}${dateTime.millisecond}"; // 20231111-231123
    return orderNo;
  }
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            flex: 6,
            child: Text(
              "${numberFormat.format(widget.paymentAmount)}원",
            ),
          ),
        ],
      ),
